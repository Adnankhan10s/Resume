        ...
        <div className='px-6 md:px-0 max-w-[1000px] mx-auto mt-40 space-y-24'>
            {
                projects.map((project , index)=>(
                    ...
                    >
                        ...
                        <div className='flex justify-center items-center md:h-[300px] md:w-[500px] w-[300px] h-[350px] object-cover'>
                            <Image width={600} height={300} src={project.src} alt={project.title} className='md:h-[300px] md:w-[500px] h-[350px] border rounded border-gray-400' />
                        </div>
